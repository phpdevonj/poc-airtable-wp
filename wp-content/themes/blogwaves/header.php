...
?>
	<header  id="masthead" class="wp-main-header">
                        ...
                        <?php if($show_topheader_social_icon) { ?>
                        	<div class="topbar-right">
                            	<ul class="social-area">
                                    ...
                                    <?php } ?>
                                    <?php if($twitter_url != "") { ?>
                                	   <li><a href="<?php echo esc_url($twitter_url); ?>" <?php if($social_icon_target) { ?> target="_blank" <?php } ?> ><i class="fa fa-times" aria-hidden="true"></i></a></li>
                                    <?php } ?>
                                    <?php if($linkedin_url != "") { ?>
		...
		<!-- Start Navbar Area -->
<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'blogwaves' ); ?>">
