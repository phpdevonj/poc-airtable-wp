<?php
  ...
  $args = array(
  'category_name' =>  get_theme_mod('darkmusic_blog_section1_category_two'),
  'posts_per_page' => get_theme_mod('darkmusic_blog_section1_category_number_of_posts_setting_two'),
  'order' => 'DESC'
);
